...
list_var_smoothing = [i for i in
                      np.linspace(1e-11, 1e-8, 10)]  # On fait varier l'hyperparamètre pour le lissage des données.
x_plot = []
acc_plot = []
f1_plot = []
...
ax2.set(xlabel='feature_range', ylabel='f1_score et accuracy',
        title='f1_score et accuracy en fonction de feature_range')
ax2.grid()
plt.legend()
...
ax3.set(xlabel='nombre de bins', ylabel='f1_score et accuracy',
        title='f1_score et accuracy en fonction du nombre de bins')
ax3.grid()
plt.legend()
plt.show()
