...
def combining(data_path, weights, RN_path, RF_path, SVM_path, SVM_N_comp, with_labels = True ):
    ...
    # ## Conversion vecteur de proba en 1 classe
    # Y_pred = []
    # for i in Y_pred_one_hot:
    #     Y_pred.append(np.argmax(i))

    # ## Transforme numeros de classes en noms
    # if with_labels == True:
...
RN_models_path = "Models/MLP_model_SSD/cp.ckpt"
#RF_models_path = "./Models/rfc_mfcc.sav"
RF_models_path = "./Models/rfc_ssd.sav"
...
write_pred_csv("SVM_SSD.csv",pred)
