...
def RF_dataset_study(path_list,n_estimators = 10,n_splits = 5):
    ...
    output:
    results (list) : liste contenant le nom du dataset avec les accuracy et f1_score associés.
    """
...
def RF_nbEstimators(X,Y,list_estimators,n_splits = 5):
    ...
    output:
    result (list) : Liste contenant l'accuracy, le f1_score, le temps d'entrainement et de prédiciton.
